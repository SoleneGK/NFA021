...
<form method="post">
	Changer le pseudo : <input type="text" name="pseudo" value="<?= $utilisateur->pseudo; ?>" /><br />
	Changer le mail : <input type="text" name="mail" value="<?= $utilisateur->mail; ?>" /><br />
	<input type="submit" value="Modifier" />
</form>

<form method="post">
	Tout le site :
	<select name="<?= Section::TOUT ?>">
